...
export default async function handler(req, res) {
  ...
  // Trata requisições de pré-verificação (CORS preflight)
    ...
    const resposta = await axios.post(
      'https://api.openai.com/v1/chat/completions',
      {
        ...
        messages: [
          {
            role: 'system',
            content: 'Você é uma consultora de imagem especialista em colorimetria, focada na cartela Inverno Profundo. Responda com autoridade e simpatia. Se receber perguntas fora do tema, responda com gentileza que não pode mudar o foco do tema.'
          },
          {
            role: 'user',
            content: pergunta
